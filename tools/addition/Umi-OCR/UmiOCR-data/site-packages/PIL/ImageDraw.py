    ...
    def text(
        ...
        **kwargs,
        ...
        def draw_text(ink, stroke_width=0, stroke_offset=None) -> None:
            ...
            try:
                mask, offset = font.getmask2(   [union-attr,misc]
                    text,
                    mode,
                    direction=direction,
                    features=features,
...
def _compute_regular_polygon_vertices(
    ...
    if not isinstance(n_sides, int):
        msg = "n_sides should be an int"   [unreachable]
        raise TypeError(msg)
    if n_sides < 3:
    ...
    if not isinstance(rotation, (int, float)):
        msg = "rotation should be an int or float"   [unreachable]
        raise ValueError(msg)
